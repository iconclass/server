...
#### Hierarchical path
[&para;](#path){: name="path" } The following example from division 7 Bible shows the __hierarchical path__ principle: all subsequent descents in the hierarchy take place by extending the notation to the right with a letter and more digits:
...
That is why the Iconclass Browser uses a __highly specific rule-base__ to interpret the elements of a notation.
...
As you can see in the Browser screen shot below, three cross references point to related terms from __52B1 · Thinking, Thought, Reflection; 'Pensiero' (Ripa)__. One of them - to __11R4 · active vs. contemplative life__ - was singled out to illustrate the principle.

{{% aimg 52b1_crossref %}}
      
In actual practice cross references are a useful discovery tool. They do not convey the _conclusion_ that images are related, but provide the _suggestion_ that further research might be useful. Angelika Kauffmann's __La Penserosa__ was tagged with [__52B1__](https://test.iconclass.org/52B1){:target="read"} in the [Virtuelles Kupferstichkabinett's](http://kk.haum-bs.de/?id=m-a-kauffmann-v3-3011){:target="read"} database, while the young woman in the print by Pieter van den Berge, tagged with [__11R4__](https://test.iconclass.org/11R4){:target="read"} in the [Rijksmuseum's database](http://hdl.handle.net/10934/RM0001.COLLECT.78627){:target="read"}, is contemplating life as an independent woman, a married woman or a nun. Juxtaposing the two does not suggest any historical relationship; it is merely a hint, automatically generated by the structure of the Iconclass schedules.
